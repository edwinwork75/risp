    ...
    return (
      <main className="p-4 md:p-10 mx-auto max-w-7xl">
        <div className="text-center py-8">
          <h2 className="text-2xl font-bold text-muted-foreground">Organization not found</h2>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {organization.orgUsers && organization.orgUsers.length > 0 && (
              <div>
                <p className="text-sm font-medium text-muted-foreground">Organization Users</p>
