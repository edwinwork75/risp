...
export default function ProjectSelectorPage() {
      ...
      <div className="container mx-auto py-6">
        ...
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <div className="text-lg font-semibold mb-2">No assigned projects found</div>
            <p className="text-muted-foreground">You don't have any projects assigned to you yet.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <div className="space-y-8">
        {Object.entries(groupedProjects).map(([orgId, orgData]) => (
          <div key={orgId} className="space-y-4">
            ...
            <div className="flex items-center justify-between border-b pb-2">
              <div className="flex items-center space-x-3">
                ...
                <Badge variant="secondary">{orgData.projects.length} assigned projects</Badge>
              </div>
            </div>
